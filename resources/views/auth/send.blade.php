            ...
            <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse; line-height:25px;">
                ...
                <tr>
                    <td style="padding: 30px 0 30px 0; text-align: center !important;">
                        <p>Berikut Kode verifikasi akun Anda adalah "{{ $otp }}"</p>
                    </td>
                </tr>

                <tr>
                    <td>
                        <p style="margin: 0;">Untuk Informasi akun Anda adalah:</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p style="margin: 0;">Nama : {{$account->name}}</p>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <p style="margin: 0;">Nomor HP : {{$account->telephone}}</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p style="margin: 0;">Alamat : {{$account->address}}</p>
                    </td>
                </tr>
            </table>
        </td>
